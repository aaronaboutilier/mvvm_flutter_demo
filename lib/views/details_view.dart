...
/// while maintaining clean separation between UI and business logic
...
class _DetailsContentState extends State<_DetailsContent> {
  ...
  /// This demonstrates how user input is handled in MVVM Views
                ...
                return FilterChip(
                  ...
                  onSelected: (selected) {
                    if (selected) {
                      ...
                      // The View doesn't contain any business logic about color selection
  ...
  /// Builds the add item section with form handling
  /// This shows how forms work in MVVM - the View handles UI state
  /// while the ViewModel handles business logic
  ...
  /// Builds the items list section with interactive elements
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            // ReorderableListView allows users to drag and reorder items
            // This demonstrates how complex UI interactions work with MVVM
            SizedBox(
  ...
  /// Adds an item through the ViewModel
  ...
  /// Maps color names to actual Color objects
  Color _getThemeColor(String colorName) {
    switch (colorName) {
      case 'Red': return Colors.red;
      case 'Blue': return Colors.blue;
      case 'Green': return Colors.green;
      case 'Yellow': return Colors.orange; // Using orange as yellow is too light
